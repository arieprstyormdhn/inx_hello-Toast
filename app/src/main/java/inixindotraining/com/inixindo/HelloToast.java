package inixindotraining.com.inixindo;
...
public class HelloToast extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //buat even handling untuk setiap komponen
        btnToast.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                //perintah untuk toast
                Toast.makeText(HelloToast.this, "Klik Tombol Toast", Toast.LENGTH_LONG).show();
            }
        });
        ...
        btnCount.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                myCount++; //ditamba 1
                if (txtDisplay != null) txtDisplay.setText(Integer.toString(myCount));
        ...
        //          public void onClick(View v) {
        //          if (txtDisplay!= null) {
        //              txtDisplay.setText(deleteFile(myCount));
        //         }
        //         }
        //             });
        ...
        btnSend.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent myIntent = new Intent(HelloToast.this,
